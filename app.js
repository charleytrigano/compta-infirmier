...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Affichage immédiat pour prévenir tout blocage visuel
...
function afficherGrandLivre() {
    ...
    if (!currentTransactions || currentTransactions.length === 0) {
        container.innerHTML = '<p style="color:#718096;">Aucune transaction enregistrée pour alimenter le Grand Livre.</p>';
        return;
    }
