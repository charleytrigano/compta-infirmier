...
function obtenirComptePCG(transaction) {
    ...
    if (texteComplet.includes('matériel') || texteComplet.includes('materiel')) {
        return { num: '606300', nom: 'Petit matériel médical' };
    }
    ...
    if (texteComplet.includes('carburant') || texteComplet.includes('déplacement')) {
        return { num: '625100', nom: 'Frais de déplacements' };
    }
...
function actualiserCalculsCarpimko() {
    ...
    const regu2025 = 1027.96 + 220.90; // Régularisation 2025 due
    ...
    // Table des Comptes Individuels (Mise à jour complète)
...
// ============================================================================
// 6. TRANSACTIONS & BILAN (CORRECTION DE LA DÉTECTION DES CATÉGORIES)
// ============================================================================
...
function genererBilanEtCE() {
    ...
    currentTransactions.forEach(t => {
        ...
        if (type.includes('recette')) {
            // Détection élargie des honoraires
